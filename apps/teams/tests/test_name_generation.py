...
class TeamNameGeneratorTest(SimpleTestCase):
    ...
    def test_name_generation_via_name(self):
        ...
        self.assertEqual("Guido Rossum", get_default_team_name_for_user(CustomUser(first_name='Guido', last_name='Rossum')))

    def test_name_generation_precedence(self):
        self.assertEqual("Guido", get_default_team_name_for_user(CustomUser(first_name='Guido', email='python@example.com')))
