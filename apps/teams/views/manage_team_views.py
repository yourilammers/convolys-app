...
from apps.teams.forms import TeamChangeForm, InvitationForm
...
def send_invitation_view(request, team_slug):
    ...
    if form.is_valid():
        ...
        pass
    return render(request, 'teams/components/team_invitations.html', {
        'invitation_form': form,
        'pending_invitations': Invitation.objects.filter(team=request.team, is_accepted=False).order_by('-created_at')
    })
