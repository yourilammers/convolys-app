"""
Django settings for Convolys project.
...
ROOT_URLCONF = 'convolys-app.urls'
...
WSGI_APPLICATION = 'convolys-app.wsgi.application'
...
if 'DATABASE_URL' in env:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': env('DJANGO_DATABASE_NAME', default='convolys-app'),
...
LANGUAGE_CODE = 'en-us'
LANGUAGE_COOKIE_NAME = 'convolys-app_language'
LANGUAGES = [
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Convolys',
    'DESCRIPTION': 'Get more out of conversations',
    'VERSION': '0.1.0',
...
LOGGING = {
    ...
    'loggers': {
        ...
        'convolys-app': {
            'handlers': ['console'],
            'level': env('CONVOLYS-APP_LOG_LEVEL', default='INFO'),
        }
    }
}
